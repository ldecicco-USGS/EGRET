...
fluxConst <- list(poundsDay = new("fluxUnit", 
                  ...
                  thousandKgDay = new("fluxUnit", 
                                      ...
                                      unitUSGS = "thousands of kilograms per day",
                                      shortCode = 4),
                  ...
                  thousandTonsYear = new("fluxUnit", 
                                         ...
                                         unitUSGS = "thousands of tons per year",
                                         shortCode = 6),
                  millionTonsYear = new("fluxUnit",
                                        ...
                                        unitUSGS = "millions of tons per year",
                                        shortCode = 7),
                  thousandKgYear = new("fluxUnit",
                                       ...
                                       unitUSGS = "thousands of kilograms per year",
                                       shortCode = 8),
                  millionKgYear = new("fluxUnit",
                                      ...
                                      unitUSGS = "millions of kilograms per year",
                                      shortCode = 9),
                  billionKgYear = new("fluxUnit",
                                      ...
                                      unitUSGS = "billions of kilograms per year",
                                      shortCode = 10),
                  thousandTonsDay = new("fluxUnit",
                                        ...
                                        unitUSGS = "thousands of tons per day",
                                        shortCode = 11),
                  millionKgDay = new("fluxUnit",
                                     ...
                                     unitUSGS = "millions of kilograms per day",
                                     shortCode = 12),
                  kgYear = new("fluxUnit",
                               shortName = "    kg/yr   ",
                               unitFactor = 365.25,
