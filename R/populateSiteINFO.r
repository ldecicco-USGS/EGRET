  ...
  if (nzchar(siteNumber)) {
    ...
    if (interactive) {
      ...
      if (!nzchar(INFO$station_nm)) {
        cat(
          "No station name was listed in the USGS site file for site:\n",
          INFO$site_no,
      ...
      if (!nzchar(INFO$drain_area_va)) {
        cat(
          "No drainage area was listed in the USGS site file for this site.\n"
        )
        cat(
      ...
      cat(
        "The drainage area at this site is ",
        INFO$drain_area_va,
        "square miles\n which is being stored as",
        INFO$drainSqKm,
        "square kilometers.\n\n"
      )
    } else {
    ...
    if (interactive) {
      ...
      INFO$drainSqKm <- INFO$drain_area_va * conversionVector[qUnit]
      cat(
        "The drainage area is being stored as",
        INFO$drainSqKm,
        "square kilometers.\n"
      )
    } else {
